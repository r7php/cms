...
<head>
    ...
    <title><?php $this->loadViewTemplate($viewName,$viewData); ?></title>
    <link rel="shortcut icon" href="<?php echo BASE_URL?>assets/logo/logo.ico" >
    <link href="vendor/fontawesome-free/css/all.min.css" rel="stylesheet" type="text/css">
    <link href="<?php echo BASE_URL?>assets/css/google.css"rel="stylesheet">
    <link href="<?php echo BASE_URL?>assets/css/sb-admin-2.min.css" rel="stylesheet">
    <link href="<?php echo BASE_URL?>assets/css/template.css" rel="stylesheet">
    <link href="<?php echo BASE_URL?>assets/css/ponto.css" rel="stylesheet">
    <link href="<?php echo BASE_URL?>assets/css/feedCriar.css" rel="stylesheet">
